...
<footer id="colophon" role="contentinfo" class="site-footer" itemscope="itemscope" itemtype="http://schema.org/WPFooter">
	...
	?>
		<div class="credits">
			...
			&nbsp; &nbsp;
			<a href="<?php echo esc_url( 'https://theme.tips' ); ?>" rel="nofollow" class="theme-credit"><?php printf( esc_html__( 'Theme: %1$s by Carolina', 'christmas-sweets' ), 'Christmas Sweets' ); ?></a>
		</div>
	<?php
	}
	?>
