...
if ( ! function_exists( 'christmas_sweets_setup' ) ) {
	...
	function christmas_sweets_setup() {
		...
		add_theme_support( 'custom-header', apply_filters( 'christmas_sweets_custom_header_args', array(
...
function christmas_sweets_scripts() {
	...
	wp_enqueue_style( 'christmas-sweets-blocks-style', get_template_directory_uri() . '/css/blocks.css' );
...
/**
 * Enqueue the Gutenberg block if Gutenberg is active
 */
if ( function_exists( 'the_gutenberg_project' ) ) {
	function christmas_sweets_block() {
		wp_enqueue_script( 'christmas-sweets-block', get_template_directory_uri() . '/js/block.js', array(
			'wp-blocks',
			'wp-i18n',
			'wp-element',
		), time() );
		$sweets_image_url = array( 'sweets_image_url' => get_template_directory_uri() . '/images/candy.png' );
		$sweets_ginger_image_url = array( 'sweets_ginger_image_url' => get_template_directory_uri() . '/images/gingerbread-small.png' );
		wp_localize_script( 'christmas-sweets-block', 'christmas_sweets_candy', $sweets_image_url );
		wp_localize_script( 'christmas-sweets-block', 'christmas_sweets_gingerbread', $sweets_ginger_image_url );
	}
	add_action( 'enqueue_block_editor_assets', 'christmas_sweets_block' );
}
