<?php
	...
	*/
	...
	function theneeds_print_meta($meta_box){
		...
		switch($meta_box['type']){
			...
			case "open" : theneeds_print_meta_open_div($meta_box); break;
			case "close" : theneeds_print_meta_close_div($meta_box); break;
			case "header": theneeds_print_meta_header($meta_box); break;
			case "text": theneeds_print_meta_text($meta_box); break;
			case "description": theneeds_print_description($meta_box); break;
			case "inputtext": theneeds_print_meta_input_text($meta_box); break;
			case "upload": theneeds_print_meta_upload($meta_box); break;
			case "textarea": theneeds_print_meta_input_textarea($meta_box); break;
			case "checkbox": theneeds_print_meta_input_checkbox($meta_box); break;
			case "combobox": theneeds_print_meta_input_combobox($meta_box); break;
			case "combobox_category": theneeds_print_meta_input_combobox_category($meta_box); break;
			case "combobox_category_main": theneeds_print_meta_input_combobox_category_main($meta_box); break;
			case "combobox_post": theneeds_print_meta_input_combobox_post($meta_box); break;
			case "combobox_revolution": theneeds_print_meta_input_combobox_revolution($meta_box); break;
			case "combobox_owl": theneeds_print_meta_input_combobox_owl($meta_box); break;
			case "combobox_latest": theneeds_print_meta_input_combobox_latest($meta_box); break;
			case "combobox_latest_filter": theneeds_print_meta_input_combobox_latest_filter($meta_box); break;
			case "combobox_latest_filter_category": theneeds_print_meta_input_combobox_latest_filter_category($meta_box); break;
			case "combobox_number_of_post": theneeds_print_meta_input_combobox_number_of_post($meta_box); break;
			case "radioenabled": theneeds_print_meta_input_radioenabled($meta_box); break;
			case "radioimage": theneeds_print_meta_input_radioimage($meta_box); break;
			case "imagepicker": theneeds_print_image_picker($meta_box); break;
			case "image": theneeds_print_set_image_picker($meta_box); break;
			case "colorpicker": theneeds_print_set_color_picker($meta_box); break;
	...
	//Select Color
	function theneeds_print_set_color_picker($meta_box){
	...
	//Image on box
	function theneeds_print_set_image_picker($meta_box){
		
	
	}
	
	// header => name, title
	function theneeds_print_meta_header($args){
	...
	// text => name, text
	function theneeds_print_meta_text($args){
	...
	function theneeds_print_meta_input_text($args){
	...
	// text => name, title, value, default
	function theneeds_print_description($args){
		extract($args);
	...
	function theneeds_print_meta_upload($args){
					...
					<div class="meta-input-example-image" id="meta-input-example-image">
						<?php 
							...
							if(!empty($value)){
								...
								echo '<img src="' . esc_url($thumb_src_preview[0]) . '" />';
							} 
	...
	function theneeds_print_meta_input_textarea($args){
	...
	function theneeds_print_meta_input_checkbox($args){
		...
		?>
			...
			<div class="meta-body span4">
				...
				<div class="meta-input <?php if(isset($class)){echo esc_attr($class);}else{$class = '';};?>">
					<?php echo esc_html__('Not yet implement','theneeds'); ?>
				</div>
	...
	function theneeds_print_meta_input_combobox($args){
		$class= '';
		extract($args);
		...
		// combobox => name, title, value, options[]
	function theneeds_print_meta_input_combobox_category($args){
		...
		?>
			...
			<div class="meta-body span4">
				...
				<div class="meta-input <?php if(isset($class)){echo esc_attr($class);}else{$class = '';};?>">
					<div class="combobox">
						<select name="<?php echo esc_attr($name); ?>" id="<?php echo str_replace('[]', '', $name); ?>">
							<option value="0" rel="0" <?php if( esc_html($fetched_value) == '0' ){ echo 'selected'; }?> ><?php echo esc_html__('All','theneeds'); ?></option>
		...
		// combobox => name, title, value, options[]
	function theneeds_print_meta_input_combobox_category_main($args){
		...
		?>
			...
			<div class="meta-body span4">
				...
				<div class="meta-input <?php if(isset($class)){echo esc_attr($class);}else{$class = '';};?>">
					<div class="combobox">
						<select name="<?php echo esc_attr($name); ?>" id="<?php echo str_replace('[]', '', $name); ?>">
							<option value="78612" rel="78612" <?php if( esc_html($fetched_value) == '78612' ){ echo 'selected'; }?> ><?php echo esc_html__('All','theneeds'); ?></option>
							<?php foreach($options as $option){ ?>
								<option value="<?php echo esc_attr($option->term_id); ?>" rel="<?php echo esc_attr($option->term_id); ?>" <?php if( $option->term_id == esc_html($fetched_value) ){ echo 'selected'; }?> ><?php echo esc_attr($option->name) ; ?></option>
							<?php } ?>
						</select>
		...
		<?php
			...
			// combobox => name, title, value, options[]
	function theneeds_print_meta_input_combobox_post($args){
		...
		?>
			...
			<div class="meta-body span4">
				...
				<div class="meta-input <?php if(isset($class)){echo esc_attr($class);}else{$class = '';};?>">
					<div class="combobox">
						<select name="<?php echo esc_attr($name); ?>" id="<?php echo str_replace('[]', '', $name); ?>">
							<option value="0"><?php echo esc_html__('--Select Any--','theneeds'); ?></option>
							<?php foreach($options as $option){ ?>
	...
	function theneeds_print_meta_input_combobox_revolution($args){
	...
	function theneeds_print_meta_input_combobox_owl($args){
	...
	function theneeds_print_meta_input_combobox_latest($args){
		...
		?>
			...
			<div class="meta-body span4">
				...
				<div class="meta-input <?php if(isset($class)){echo esc_attr($class);}else{$class = '';};?>">
					<div class="combobox">
						<select name="<?php echo esc_attr($name); ?>" id="<?php echo str_replace('[]', '', $name); ?>">
							<option value="0" rel="0"><?php echo esc_html__('--Select Any--','theneeds'); ?></option>
							<?php foreach($options as $option){ ?>
	...
	function theneeds_print_meta_input_combobox_latest_filter($args){
	...
	function theneeds_print_meta_input_combobox_latest_filter_category($args){
	...
	function theneeds_print_meta_input_combobox_number_of_post($args){
		extract($args);
	...
	function theneeds_print_meta_input_radioenabled($args){
		...
		?>
			...
			<div class="meta-body span4">
				...
				<div class="meta-input <?php if(isset($class)){echo esc_attr($class);}else{$class = '';};?>">
					<input type="radio" name="<?php echo esc_attr($name); ?>" value="enabled" <?php if($value=='enabled' || $value=='') echo 'checked'; ?>><?php echo esc_html__('Enable','theneeds'); ?>  &nbsp&nbsp&nbsp
					<input type="radio" name="<?php echo esc_attr($name); ?>" value="disable" <?php if($value=='disable') echo 'checked'; ?>><?php echo esc_html__('Disable','theneeds'); ?> 
				</div>
				<?php if(isset($description)){ ?>
					<div class="meta-description"><?php echo esc_attr($description); ?></div>
				<?php } ?>
	...
	function theneeds_print_meta_input_radioimage($args){
					...
					<?php foreach( $options as $option ){ ?>
						...
						<span class="head-sec-sidebar"><?php echo str_replace('-',' ',$option['value']); ?></span>
							<label for="<?php echo esc_attr($option['value']); ?>">
								<img src=<?php echo theneeds_PATH_URL.$option['image']?> alt=<?php echo esc_attr($name);?>>
	...
	function theneeds_print_image_picker($args){
		extract($args);
		?>	
				...
				<div class="meta-input-slider">
					<div class="image-picker" id="image-picker">
						...
						<div class="selected-image" id="selected-image">
							<div id="selected-image-none"><?php echo esc_html__('No Gallery Items Inserted','theneeds'); ?></div>
							<ul>
								<li id="default" class="default">
									<div class="selected-image-wrapper">
										<img src="" alt="<?php esc_html('image','theneeds');?>" />
										...
										<div class="meta-input meta-detail-input">
											<div class="combobox">
												<select id='<?php echo esc_attr($name['linktype']); ?>'>
													<option selected ><?php echo esc_html__('No Link','theneeds'); ?></option>
													<option><?php echo esc_html__('Lightbox','theneeds'); ?></option>
													<option><?php echo esc_html__('Link to URL','theneeds'); ?></option>	
													<option><?php echo esc_html__('Link to Video','theneeds'); ?></option>
												</select>
											</div>
											<div class="meta-title meta-detail-title ml0 mt5" rel="url"><?php esc_html_e('URL PATH', 'theneeds'); ?></div> 
											<div class="meta-title meta-detail-title ml0 mt5" rel="video"><?php esc_html_e('VIDEO PATH (ONLY FOR ANYTHING SLIDER)', 'theneeds'); ?></div> 
									...
									if(!empty($value)){
										...
										foreach ($value->childNodes as $slider){ ?> 
											...
											<li class="slider-image-init">
												...
												<input type="hidden" class='slider-image-url' name='<?php echo esc_attr($name['image']); ?>[]' id='<?php echo esc_attr($name['image']); ?>[]' value="<?php echo esc_url(theneeds_find_xml_value($slider, 'image')); ?>" /> 
												<div id="slider-detail-wrapper" class="slider-detail-wrapper">
												<div id="slider-detail" class="slider-detail">								
													<div class="meta-title meta-detail-title"><?php esc_html_e('SLIDER TITLE', 'theneeds'); ?></div> 
													<div class="meta-detail-input meta-input"><input type="text" name='<?php echo esc_attr($name['title']); ?>[]' id='<?php echo esc_attr($name['title']); ?>[]' value="<?php echo esc_attr(theneeds_find_xml_value($slider, 'title')); ?>" /></div><br class="clear">
													<hr class="separator">
													<div class="meta-title meta-detail-title"><?php esc_html_e('SLIDER CAPTION', 'theneeds'); ?></div>
													<div class="meta-detail-input meta-input"><textarea name='<?php echo esc_attr($name['caption']); ?>[]' id='<?php echo esc_attr($name['caption']); ?>[]' ><?php echo esc_attr(theneeds_find_xml_value($slider, 'caption')); ?></textarea></div><br class="clear">
													<hr class="separator">
													<div class="meta-title meta-detail-title"><?php esc_html_e('LINK TYPE', 'theneeds'); ?></div>
													<div class="meta-input meta-detail-input">
														<div class="combobox">
															<?php $linktype_val =  theneeds_find_xml_value($slider, 'linktype'); ?>
															<select name='<?php echo esc_attr($name['linktype']); ?>[]' id='<?php echo esc_attr($name['linktype']); ?>' >
																<option <?php echo ($linktype_val == 'No Link')? "selected" : ''; ?> ><?php echo esc_html__('No Link','theneeds'); ?></option>
																<option <?php echo ($linktype_val == 'Lightbox')? "selected" : ''; ?>><?php echo esc_html__('Lightbox','theneeds'); ?></option>
																<option <?php echo ($linktype_val == 'Link to URL')? "selected" : ''; ?>><?php echo esc_html__('Link to URL','theneeds'); ?></option>
																<option <?php echo ($linktype_val == 'Link to Video')?  "selected" : ''; ?>><?php echo esc_html__('Link to Video','theneeds'); ?></option>
															</select>
														</div>
														<div class="meta-title meta-detail-title ml0 mt5" rel="url"><?php esc_html_e('URL PATH', 'theneeds'); ?></div> 
														<div class="meta-title meta-detail-title ml0 mt5" rel="video"><?php esc_html_e('VIDEO PATH (ONLY FOR ANYTHING SLIDER)', 'theneeds'); ?></div> 
														<div><input class="mt10" type="text" name='<?php echo esc_attr($name['link']); ?>[]' id='<?php echo esc_attr($name['link']); ?>[]' value="<?php echo theneeds_find_xml_value($slider, 'link'); ?>" /></div>
													</div>
...
<?php }
	// open => id
	function theneeds_print_meta_open_div($args){
		extract($args);
		?>
...
<?php }
	...
	// close
	function theneeds_print_meta_close_div($args){	
	?>		
	</div>			
<?php }
	
	// save option function that trigger when saving each post
	add_action('save_post','theneeds_save_option_meta');
	function theneeds_save_option_meta($post_id){
	...
	function theneeds_save_meta_data($post_id, $new_data, $old_data, $name){
