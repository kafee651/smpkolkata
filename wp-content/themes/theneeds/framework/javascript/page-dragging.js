...
jQuery(document).ready(function () {
    ...
    jQuery("div.combobox #page-option-item-testimonial-display-type").change(function () {
        var theneeds_category = jQuery(this).parents(".meta-body").siblings(".meta-body").find("#page-option-item-testimonial-category");
        var theneeds_specific = jQuery(this).parents(".meta-body").siblings(".meta-body").find("#page-option-item-testimonial-specific");
        if (jQuery(this).val() == 'Testimonial Category') {
            theneeds_specific.parents(".meta-body").slideUp();
            theneeds_category.parents(".meta-body").slideDown();
        } else {
            theneeds_category.parents(".meta-body").slideUp();
            theneeds_specific.parents(".meta-body").slideDown();
        }
    });
    jQuery("div.combobox #page-option-item-testimonial-display-type").each(function () {
        ...
        var theneeds_specific = jQuery(this).parents(".meta-body").siblings(".meta-body").find("#page-option-item-testimonial-specific");
        if (jQuery(this).val() == 'Testimonial Category') {
            theneeds_specific.parents(".meta-body").css('display', 'none');
            theneeds_category.parents(".meta-body").css('display', 'block');
        } else {
            theneeds_category.parents(".meta-body").css('display', 'none');
            theneeds_specific.parents(".meta-body").css('display', 'block');
        }
    });
    ...
    jQuery("div.combobox #page-option-item-attraction-view").change(function () {
        var theneeds_location = jQuery(this).parents(".meta-body").siblings(".meta-body").find("#page-option-item-attraction-location");
        var theneeds_category = jQuery(this).parents(".meta-body").parent().find("#hide_show_element");
		var theneeds_pagination = jQuery(this).parents(".meta-body").siblings(".meta-body").find("#page-option-item-attraction-pagination");
        if (jQuery(this).val() == 'Listing View') {
            theneeds_location.parents(".meta-body").slideUp();
            theneeds_category.slideDown();			
        } else {
            theneeds_category.slideUp();
			theneeds_location.parents(".meta-body").slideDown();
        }
    });
    jQuery("div.combobox #page-option-item-attraction-view").each(function () {
        var theneeds_location = jQuery(this).parents(".meta-body").siblings(".meta-body").find("#page-option-item-attraction-location");
        var theneeds_complete = jQuery(this).parents(".meta-body").parent().find("#hide_show_element");
		var theneeds_pagination = jQuery(this).parents(".meta-body").siblings(".meta-body").find("#page-option-item-attraction-pagination");
        if (jQuery(this).val() == 'Listing View') {
            theneeds_location.parents(".meta-body").css('display', 'none');
            theneeds_complete.css('display', 'block');
        } else {
			theneeds_complete.css('display', 'none');
            theneeds_location.parents(".meta-body").css('display', 'block');
        }
    });
	
	// Event Option
    jQuery("div.combobox #page-option-item-event-view").change(function () {
        var theneeds_event_listing = jQuery(this).parents(".meta-body").parent().find("#event_type_open");
        if (jQuery(this).val() == 'Listing View') {
            theneeds_event_listing.slideDown();			
        } else {
            theneeds_event_listing.slideUp();			
        }
    });
    jQuery("div.combobox #page-option-item-event-view").each(function () {
        var theneeds_event_listing = jQuery(this).parents(".meta-body").parent().find("#event_type_open");
        if (jQuery(this).val() == 'Listing View') {
            theneeds_event_listing.css('display', 'block');
        } else {
			theneeds_event_listing.css('display', 'none');
        }
    });
	
	// Filterable Condition for PRoduct Option
    jQuery("div.combobox #page-option-item-product-filterable").change(function () {
        var theneeds_product_listing = jQuery(this).parents(".meta-body").parent().parent().find("#product-type-hide");
        if (jQuery(this).val() == 'No') {
            theneeds_product_listing.slideDown();			
        } else {
            theneeds_product_listing.slideUp();			
        }
    });
    jQuery("div.combobox #page-option-item-product-filterable").each(function () {
        var theneeds_product_listing = jQuery(this).parents(".meta-body").parent().parent().find("#product-type-hide");
        if (jQuery(this).val() == 'No') {
            theneeds_product_listing.css('display', 'block');
        } else {
			theneeds_product_listing.css('display', 'none');
        }
    });
	
	
	jQuery("div.combobox #page-option-item-product-layout").change(function () {
        var theneeds_product_listing_filter = jQuery(this).parents(".meta-body").parent().find("#product-type-filterable");
		var theneeds_product_pagi = jQuery(this).parents(".meta-body").parent().find("#product-type-hide");
        if (jQuery(this).val() == 'Grid') {
            theneeds_product_listing_filter.slideDown();
			theneeds_product_pagi.slideDown();
        } else {
            theneeds_product_listing_filter.slideUp();
			theneeds_product_pagi.slideDown();
        }
    });
    jQuery("div.combobox #page-option-item-product-layout").each(function () {
		...
		var theneeds_product_pagi = jQuery(this).parents(".meta-body").parent().find("#product-type-hide");
        if (jQuery(this).val() == 'Grid') {
            theneeds_product_listing_filter.css('display', 'block');
			theneeds_product_pagi.css('display', 'block');
        } else {
			theneeds_product_listing_filter.css('display', 'none');
			theneeds_product_pagi.css('display', 'block');
        }
    });
