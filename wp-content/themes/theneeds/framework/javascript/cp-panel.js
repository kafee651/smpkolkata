...
jQuery(document).ready(function () {
	...
	var counter = 0;
    jQuery(".bootstrap_admin a#add-more-data").click(function () {
		var clone_item = jQuery(this).parent().parent().parent().parent().siblings('.bootstrap_admin').find('.cp-element-item').clone(true);
		
		var clone_field_name = jQuery(this).parent().parent().siblings('.span5').find('input.theneeds_field_name').val();
		var clone_field_val = jQuery(this).parent().parent().siblings('.span5').find('input.theneeds_field_value').val();
        ...
        clone_item.find('input#theneeds_field_name').attr('value', clone_field_name);
		clone_item.find('input#theneeds_field_value').attr('value', clone_field_val);
		
        clone_item.find('.panel-title').find('h3').text(clone_field_name);
		clone_item.find('.panel-title').find('input').text(clone_field_val);			
        jQuery("#add_data_elements").append(clone_item);
        jQuery(".element-item").slideDown();
		jQuery(this).parent().parent().siblings('.span5').find('input.theneeds_field_name').val('Field Name');
		jQuery(this).parent().parent().siblings('.span5').find('input.theneeds_field_value').val('Field Value');
    });
   ...
   // Add Multiple Ingredients
	var counter = 0;
    jQuery(".progress_bar_section a#add-more-data").click(function () {
		var clone_item = jQuery(this).parent().parent().parent().parent().siblings('.progress_bar_section').find('.cp-element-item').clone(true);
		
		var clone_field_name = jQuery(this).parent().parent().siblings('.span5').find('input.theneeds_field_title').val();
		var clone_field_val = jQuery(this).parent().parent().siblings('.span2').find('input.theneeds_field_percent').val();
        if (clone_field_name.indexOf("&") > 0) {
            alert('You can\'t use the special charactor ( such as & ) as the ingre name.');
            return;
        }
        ...
        clone_item.find('input#theneeds_field_title').attr('value', clone_field_name);
		clone_item.find('input#theneeds_field_percent').attr('value', clone_field_val);
		
        clone_item.find('.panel-title').find('h3').text(clone_field_name);
		clone_item.find('.panel-title').find('input').text(clone_field_val);			
        jQuery("#add_data_elements").append(clone_item);
        jQuery(".element-item").slideDown();
		jQuery(this).parent().parent().siblings('.span5').find('input.theneeds_field_title').val('Field Title');
		jQuery(this).parent().parent().siblings('.span2').find('input.theneeds_field_percent').val('Field Percent');
    });
    jQuery(".element-item").css('float', 'left');
    jQuery(".panel-delete-field").click(function () {
   ...
   //End of Default Custom Field Code
    ...
    jQuery("input.upload-font-button").click(function () {
        ...
        font_name_box = jQuery(this).parents('#font-item').find(".theneeds_upload_font_name");
    ...
    jQuery(".font_google").change(function () {
		...
		if(select_object_type == 'ADOBE EDGE FONT'){
			var sample_text = selected_combobox.parent().parent().parent().find("#option-font-sample");
				...
				jQuery.post(ajaxurl, {
					action: 'get_theneeds_typekit_url',
	...
	jQuery("#header_logo_cp div.checkbox-switch").click(function () {
        if (jQuery(this).hasClass('checkbox-switch-on')) {
			jQuery(this).parent().parent().parent().parent().find('.theneeds_logo_text').addClass('default-slider-hide');
			jQuery(this).parent().parent().parent().parent().parent().find('.theneeds_logo').removeClass('default-slider-hide');
        } else {
			jQuery(this).parent().parent().parent().parent().find('.theneeds_logo_text').removeClass('default-slider-hide');
			jQuery(this).parent().parent().parent().parent().parent().find('.theneeds_logo').addClass('default-slider-hide');
        }
	...
	if (jQuery('#header_logo_cp .header_logo_btn label div').hasClass('checkbox-switch-on')) {
		jQuery('#header_logo_cp .header_logo_btn label div').parent().parent().parent().parent().find('.theneeds_logo_text').addClass('default-slider-hide');
		jQuery('#header_logo_cp .header_logo_btn label div').parent().parent().parent().parent().parent().find('.theneeds_logo').removeClass('default-slider-hide');
	} else {
		jQuery('#header_logo_cp .header_logo_btn label div').parent().parent().parent().parent().find('.theneeds_logo_text').removeClass('default-slider-hide');
		jQuery('#header_logo_cp .header_logo_btn label div').parent().parent().parent().parent().parent().find('.theneeds_logo').addClass('default-slider-hide');
	}
    ...
    jQuery('.radio-image-wrapper input').change(function () {
        ...
        if (jQuery(this).val() == 'right-sidebar') {
            panel_body.find('.theneeds_right_sidebar').removeClass('default-slider-hide');
            panel_body.find('.theneeds_left_sidebar').addClass('default-slider-hide');
        } else if (jQuery(this).val() == 'left-sidebar') {
            panel_body.find('.theneeds_right_sidebar').addClass('default-slider-hide');
            panel_body.find('.theneeds_left_sidebar').removeClass('default-slider-hide');
    ...
    if (selected_class == 'layer_slider') {
        ...
        jQuery('.theneeds_select_slider').slideDown();
    }
    ...
    jQuery('#home_select_slider').change(function () {
        ...
        if (option_class == 'layer_slider') {
            jQuery('.layer_slider_shortcode').slideDown();
            jQuery('.theneeds_select_slider').slideUp();
        } else {
            jQuery('.layer_slider_shortcode').slideUp();
            jQuery('.theneeds_select_slider').slideDown();
        }
    ...
    //background combobox
    jQuery('#theneeds_background_style').change(function () {
        if (jQuery(this).val() == 'Pattern') {
            jQuery(this).parents('.panel-body').siblings('.body-theneeds_background_pattern').removeClass('default-slider-hide');
            jQuery(this).parents('.panel-body').siblings('.body-theneeds_background_custom').addClass('default-slider-hide');
        } else if (jQuery(this).val() == 'Custom Image') {
            jQuery(this).parents('.panel-body').siblings('.body-theneeds_background_pattern').addClass('default-slider-hide');
            jQuery(this).parents('.panel-body').siblings('.body-theneeds_background_custom').removeClass('default-slider-hide');
        } else {
            jQuery(this).parents('.panel-body').siblings('.body-theneeds_background_pattern').addClass('default-slider-hide');
            jQuery(this).parents('.panel-body').siblings('.body-theneeds_background_custom').addClass('default-slider-hide');
        }
    ...
    jQuery('#theneeds_background_style').each(function () {
        if (jQuery(this).val() == 'Pattern') {
            jQuery(this).parents('.panel-body').siblings('.body-theneeds_background_pattern').removeClass('default-slider-hide');
            jQuery(this).parents('.panel-body').siblings('.body-theneeds_background_custom').addClass('default-slider-hide');
        } else if (jQuery(this).val() == 'Custom Image') {
