...
*/
if(!class_exists("theneeds_campaign_list")){
	class theneeds_campaign_list{
		static $add_plugin_script;
		function __construct(){
			add_action("init",array($this,"theneeds_campaign_list_init"));
			add_shortcode('theneeds_campaign_list',array($this,'theneeds_campaign_list_shortcode'));
		}
		function theneeds_campaign_list_init(){
			...
			if(function_exists("vc_map")){
				...
				vc_map( array(
					"base" => "theneeds_campaign_list",
					"name" => __( "Campaign List", "js_composer" ),
					"class" => "theneeds_campaign_list_class",
					"category" => __( 'CrunchPress', 'js_composer' ),
					"icon" => "theneeds_campaign_list_news_full",
					"params" => array(
		...
		function theneeds_campaign_list_shortcode( $atts, $content = null ) {
	...
	new theneeds_campaign_list;
	
	if(class_exists('WPBakeryShortCode'))
	{
		class WPBakeryShortCode_theneeds_campaign_list extends WPBakeryShortCode {
		}
	}
}