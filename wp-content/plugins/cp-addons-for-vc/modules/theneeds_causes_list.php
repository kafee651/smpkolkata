...
*/
if(!class_exists("theneeds_causes_list")){
	class theneeds_causes_list{
		static $add_plugin_script;
		function __construct(){
			add_action("init",array($this,"theneeds_causes_list_init"));
			add_shortcode('theneeds_causes_list',array($this,'theneeds_causes_list_shortcode'));
		}
		function theneeds_causes_list_init(){
			...
			if(function_exists("vc_map")){
				...
				vc_map( array(
					"base" => "theneeds_causes_list",
					"name" => __( "Causes List", "js_composer" ),
					"class" => "theneeds_causes_list_class",
					"category" => __( 'CrunchPress', 'js_composer' ),
					"icon" => "theneeds_causes_list_news_full",
					"params" => array(
						...
						array(
							...
							"holder" => "p",
							"class" => "",
							"heading" => __( "Causes Count", "js_composer" ),
							"param_name" => "num_posts",
							"description" => __( "Enter Number of Causes to Fetch", "js_composer" )
						),
		...
		function theneeds_causes_list_shortcode( $atts, $content = null ) {
			...
			$output = '
				...
				<section class="causes-style-1 causes-list">
								...
								if(class_exists("Deck")){
									...
									$output .= '
									 ...
									 <div class="box">
									  <div class="row">
										<div class="col-md-6">
										  <div class="frame"><a href="'.esc_url(get_the_permalink()).'">'.get_the_post_thumbnail($post->ID, array(390,320)).'</a></div>
										</div>
										<div class="col-md-6">
										  <div class="text-box">
											<h3>'.get_the_title().'</h3>
	...
	new theneeds_causes_list;
	
	if(class_exists('WPBakeryShortCode'))
	{
		class WPBakeryShortCode_theneeds_causes_list extends WPBakeryShortCode {
		}
	}
}