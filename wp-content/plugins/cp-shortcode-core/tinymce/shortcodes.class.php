...
class class_shortcodes
{
	...
	{
		global $theneeds_shortcodes;
		
		// get config file
		require_once( $this->conf );

		unset($theneeds_shortcodes['shortcode-generator']['params']['select_shortcode']);
		if( isset( $theneeds_shortcodes[$this->popup]['child_shortcode'] ) )
			$this->has_child = true;

		if( isset( $theneeds_shortcodes ) && is_array( $theneeds_shortcodes ) )
		{
			// get shortcode config stuff
			$this->params = $theneeds_shortcodes[$this->popup]['params'];
			$this->shortcode = $theneeds_shortcodes[$this->popup]['shortcode'];
			$this->popup_title = $theneeds_shortcodes[$this->popup]['popup_title'];
			...
			if( isset( $theneeds_shortcodes[$this->popup]['no_preview'] ) && $theneeds_shortcodes[$this->popup]['no_preview'] )
			{
			...
			{
				// set child shortcode
				$this->cparams = $theneeds_shortcodes[$this->popup]['child_shortcode']['params'];
				$this->cshortcode = $theneeds_shortcodes[$this->popup]['child_shortcode']['shortcode'];
				...
				$prow_end	.= '<a href="#" id="form-child-add">' . $theneeds_shortcodes[$this->popup]['child_shortcode']['clone_button'] . '</a>' . "\n";
				$prow_end   .= '</td>' . "\n";
				$prow_end   .= '</tr>' . "\n";
				$prow_end   .= '</tbody>' . "\n";
