...
jQuery(document).ready(function($) {
    window.theneeds_tb_height = (92 / 100) * jQuery(window).height();
    window.theneeds_shortcodes_height = (71 / 100) * jQuery(window).height();
    if(window.theneeds_shortcodes_height > 550) {
        window.theneeds_shortcodes_height = (74 / 100) * jQuery(window).height();
    }
    ...
    crunchpress_shortcodes = {
    	...
    	resizeTB: function()
    	{
            ...
            tbWindow.css({
                height: window.theneeds_tb_height,
            ...
            $('#crunchp-sc-form-wrap #cp-sc-form').height(window.theneeds_shortcodes_height);
    	...
    	load: function()
    	{
			...
			$('.theneeds_shortcode_icon').click(function() {
